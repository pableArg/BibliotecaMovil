...
class VolumeInfo(val title : String, val authors : ArrayList<String>, val publishedDate : String, val industryIdentifiers : ArrayList<Identifier>,
                 ...
                 val panelizationSummary : Panel, val imageLinks : ImageLink = ImageLink("https://png.pngtree.com/element_our/20190604/ourmid/pngtree-college-entrance-examination-book-illustration-image_1467961.jpg",
        "https://png.pngtree.com/element_our/20190604/ourmid/pngtree-college-entrance-examination-book-illustration-image_1467961.jpg"), val language : String, val previewLink : String, val infoLink : String, val canonicalVolumeLink : String)
...
class ImageLink(val smallThumbnail : String, val thumbnail : String = "https://png.pngtree.com/element_our/20190604/ourmid/pngtree-college-entrance-examination-book-illustration-image_1467961.jpg")
